...
exports.home = function(request, response){
    db.query('SELECT * FROM topic',function(err, topics){
        db.query('SELECT * FROM author',function(err2, authors){
            ...
            <form action='/authors/create_proccess' method="post">
                <p>
...
exports.create_proccess = function(request, response){
    var body = '';
    ...
    db.query('SELECT * FROM topic',function(err, topics){
        db.query('SELECT * FROM author',function(err2, authors){
            ...
            db.query('SELECT * FROM author WHERE id=?', [queryData.id], function(err3, author){
                ...
                <form action='/authors/update_proccess' method="post">
                    <p>
...
exports.update_proccess = function(request, response){
    var body = '';
    request.on('data', function(data){
        body = body + data;
    });
...
exports.delete_proccess = function(request, response){
    var body = '';
    request.on('data', function(data){
        body = body + data;
    });
